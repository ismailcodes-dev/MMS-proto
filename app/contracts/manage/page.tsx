...
import { 
  ...
  DollarSign, MapPin, Search, Plus, Filter,
  MoreVertical, Printer, MessageSquare, AlertCircle,
...
export default function ContractManagePage() {
  ...
  return (
    <div className="flex h-screen bg-[#0f111a] text-slate-200 font-sans overflow-hidden">
      ...
      <aside className="w-80 bg-[#141824] border-r border-slate-700 flex flex-col z-20">
        ...
        <div className="flex-1 overflow-y-auto">
           {filteredContracts.map((contract) => (
             ...
             >
                ...
                {/* Mini Progress Bar for Payments */}
      ...
      {/* --- 2. MAIN CONTENT: CONTRACT DETAILS (Existing Logic) --- */}
      <main className="flex-1 overflow-y-auto bg-[#0f111a] relative pb-20">
        
        {/* Header Strip */}
        <div className="sticky top-0 bg-[#1F2436]/95 backdrop-blur border-b border-slate-700 p-6 z-10 flex justify-between items-start shadow-md">
           <div>
        ...
        {/* DASHBOARD KPI (Only for Active Contracts) */}
        {activeContract.status === 'Active' && (
        ...
        <div className="p-6 grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2 border border-slate-700 rounded-lg bg-[#1F2436] overflow-hidden">
               ...
               <tbody className="divide-y divide-slate-700">
                 {visits.map((visit) => (
                   <tr key={visit.id} className="hover:bg-[#141824]">
                     <td className="px-4 py-3 text-white font-mono">{visit.date}</td>
